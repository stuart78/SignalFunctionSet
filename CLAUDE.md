...
- `src/kit.cpp` — Kit (`src/membrane.hpp` = the modal membrane, measurable without Rack; `tools/kit-stereo-harness.py` = offline stereo-image harness)
- `src/trace.cpp` — Trace
