...
// SFS addition: bitmask of carrier ops (bit `op` set when that operator writes
// to the output bus) for a given algorithm. Used by Bell's brightness macro to
// scale only the modulator operators.
int fmCoreCarrierMask(int algorithm);
