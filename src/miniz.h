/* miniz 3.0.2 — vendored into Signal Function Set for Play, which unzips
   DecentSampler .dslibrary packs with it. Rack's own unarchiver runs
   `tar --zstd` and nothing else, and libRack exports no zlib or libarchive
   symbol, so the plugin has to carry a zip reader of its own.

   Upstream: https://github.com/richgel999/miniz — the 3.0.2 release
   amalgamation, unmodified apart from this header comment.

   Copyright 2013-2014 RAD Game Tools and Valve Software
   Copyright 2010-2014 Rich Geldreich and Tenacious Software LLC
   Licensed under the MIT licence — the full text is in src/miniz.c, and is
   reproduced there in each of the amalgamated sections it came from. The
   Signal Function Set plugin as a whole is GPL-3.0-or-later; MIT is
